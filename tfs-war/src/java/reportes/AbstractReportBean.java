...
import recursos.ReportConfigUtil;
import dao.Database;
...
public abstract class AbstractReportBean {
    ...
    private final String COMPILE_DIR = "C:\\Users\\RafaTrossero\\Documents\\NetBeansProjects\\tfs\\tfs-war\\web";
    private String compileFileName = "reporteProyecto";//name of your compiled report file
    ...
    protected void prepareReport(Long proyId) throws JRException, IOException {
        
        Map parametro = new HashMap();
        parametro.put("idProyecto", proyId);
        ...
        File reportFile = new File(ReportConfigUtil.getJasperFilePath(context,  "reporteProyecto.jasper"));
        ...
        JasperPrint jasperPrint = ReportConfigUtil.fillReport(reportFile,parametro, conn);
