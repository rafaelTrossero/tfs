...
public class BorradorBean {
    ...
    private boolean notaCodirector = false; 
    ...
    public void create() {
        ...
        try {
            ...
            System.out.println("notaCodirector " + this.notaCodirector);
            ...
            borrador.setRuta(fileUploadController.destino);

            /* ----------------------------------------------------------
             Para la presentacion de Borradores de Proyectos
             ----------------------------------------------------------------*/
            if ((this.notaDirector==true || this.notaCodirector==true)  && borrador.getProyecto().getEstado().getId().equals(5L) || borrador.getProyecto().getEstado().getId().equals(11L)) {

              
                //consulta me devuelve el registro del estado igual a 8 "En proceso de revisión de borradores"
                ...
                borrador.setNota_codirector(true);// Como notaDirector= 's' . en la tabla pongo un 1
            ...
            if ((this.notaDirector==false && this.notaCodirector==false) && borrador.getProyecto().getEstado().getId().equals(5L)) {

            
                //consulta me devuelve el registro del estado igual a 11 "Se requiere una nueva presentación del Borrador"
                estado = proyectoRNbeanLocal.findByEstado(11);
                System.out.println("El estado es:" + estado.getEstado());
                proyecto.setEstado(estado);
                ...
                borrador.setNota_codirector(false);
            ...
            /* ----------------------------------------------------------
             ...
             ----------------------------------------------------------------*/
            if ((this.notaDirector==true || this.notaCodirector== true) && borrador.getProyecto().getEstado().getId().equals(10L)) {
                ...
                borrador.setNota_director(true);
                borrador.setNota_codirector(true);
            ...
            if ((this.notaDirector==false && this.notaCodirector==false) && borrador.getProyecto().getEstado().getId().equals(10L)) {
