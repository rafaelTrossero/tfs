...
public class ListaNoticiasBean {
    ...
    @PostConstruct
    void init() {
        System.out.println("PostConstructor ListaNoticiasBeannnn");
  ...
  public void paginaSig (){
     ...
     if(this.num3+3<lstNoticias.size()){
      ...
      RequestContext.getCurrentInstance().update("seccionNoticias");
    //  return "index.xhtml";
  }
   ...
   public void handleFileUploadPhoto() {
        System.out.println("sssssENTRO AL UPLOAD IMAGEN DE LISTA NOTICIAS BEAN" + file);
        if (file != null) {
            try {
               ...
               /* Connection con = Database.getConnection();
                ...
                pre.executeUpdate();*/
               noticias.setImageNoticia(file.getContents());
