...
public class ProyectosInvestigacionBean {
    ...
    //0 crea
        ...
        if (btnSelect.getId().equals("cbCreate")) {
           ...
           System.out.println("entro por el editar seguro");
      ...
      public void create() {
        ...
        try {
            ...
            sMensaje = "Proyectos de Investigacion guardado correctamente";
            ...
            context.execute("PF('dlgProyectosInvestigacion').hide();");
    ...
    public void edit() {
        ...
        try {
            ...
            sMensaje = "Datos de proyecto actualizados correctamente";
            severity = FacesMessage.SEVERITY_INFO;
            ...
            this.getCbAction().setDisabled(true);
             RequestContext context = RequestContext.getCurrentInstance();
            context.execute("dlgProyectosInvestigacion.hide()");
     ...
     public void activate(Boolean bEstado) {
        ...
        try {
            ...
            if (!bEstado) {
                sMensaje = "Proyecto de Investigacion deshabilitada correctamente";
            } else {
                sMensaje = "Proyecto de Investigacion habilitada correctamente";
            }
            severity = FacesMessage.SEVERITY_INFO;
