...
public class OperacionBean {
    ...
    private CronogramaActividad cronogramaObj;
    private Cronograma cronogramaOriginal;
    @EJB
    ...
    @EJB
    private CronogramaActividadRNLocal cronoActividadRNLocal;
    ...
    private Encriptacion a = new Encriptacion();
    @EJB
    ...
    public Cronograma getCronogramaOriginal() {
        return cronogramaOriginal;
    }

    public void setCronogramaOriginal(Cronograma cronogramaOriginal) {
        this.cronogramaOriginal = cronogramaOriginal;
    }
    ...
    public CronogramaActividad getCronogramaObj() {
        return cronogramaObj;
    }

    public void setCronogramaObj(CronogramaActividad cronogramaObj) {
    ...
    public void crear() throws Exception {
        ...
        crearCodirector();
        crearasesor();
        listaCronogramaBean.cargar_Cronograma(proyecto);
    ...
    public String seleccionar_operacion() throws Exception {
        ...
        if (this.getListaOperacionBean().getSelectedOpe().getId().equals(1L)) {
            ...
            context.execute("PF('dlgModTitulo').show()");
            crear();
            return null;
        }
        if (this.getListaOperacionBean().getSelectedOpe().getId().equals(2L)) {
            ...
            context.execute("PF('dlgBajaDir').show()");
            creardirector();
            return null;
        }
        if (this.getListaOperacionBean().getSelectedOpe().getId().equals(3L)) {
            ...
            context.execute("PF('dlgAltaCodirector').show()");
            crearCodirector();
            return null;
        }
        if (this.getListaOperacionBean().getSelectedOpe().getId().equals(4L)) {
            ...
            context.execute("PF('dlgAltaAsesor').show()");
            crearasesor();
            return null;
        }
        if (this.getListaOperacionBean().getSelectedOpe().getId().equals(5L)) {
            ...
            context.execute("PF('dlgBajaDir2').show()");
            creardirector();
            return null;
        }
        if (this.getListaOperacionBean().getSelectedOpe().getId().equals(6L)) {
            ...
            context.execute("PF('dlgBajaCodirector').show()");
            crearCodirector();
            return null;
        }
        if (this.getListaOperacionBean().getSelectedOpe().getId().equals(7L)) {
            ...
            context.execute("PF('dlgBajaAsesor').show()");
            crearasesor();
            return null;
        }
        if (this.getListaOperacionBean().getSelectedOpe().getId().equals(11L)) {
            ...
            context.execute("PF('dlgBajaTribunal').show()");
            crear();
            return null;
        ...
        if (this.getListaOperacionBean().getSelectedOpe().getId().equals(10L)) {
            ...
            context.execute("PF('dlgAltaTribunal').show()");
            return null;
        ...
        if (this.getListaOperacionBean().getSelectedOpe().getId().equals(13L)) {
            ...
            return ("cronograma.xhtml?faces-redirect=true");
    ...
    public void alta_dir() throws Exception {
        ...
        try {
            ...
            RequestContext context = RequestContext.getCurrentInstance();
            context.execute("PF('dlgBajaDir').hide()");
    ...
    public void baja_dir() throws Exception {
        ...
        try {
            ...
            severity = FacesMessage.SEVERITY_INFO;
            RequestContext context = RequestContext.getCurrentInstance();
            context.execute("PF('dlgBajaDir2').hide()");
            observacion = "";
    ...
    public void alta_Asesor() throws Exception {
        ...
        try {
            ...
            RequestContext context = RequestContext.getCurrentInstance();
            context.execute("PF('dlgAltaAsesor').hide()");
    ...
    public void alta_Codirector() throws Exception {
        ...
        try {
            ...
            RequestContext context = RequestContext.getCurrentInstance();
            context.execute("PF('dlgAltaCodirector').hide()");
        } catch (Exception ex) {
            severity = FacesMessage.SEVERITY_ERROR;
            sMensaje = "Error al dar de ALTA: " + ex.getMessage();
    ...
    public void baja_asesor() throws Exception {
        ...
        try {
            ...
            RequestContext context = RequestContext.getCurrentInstance();
            context.execute("PF('dlgBajaAsesor').hide()");
            obs = "";
        } catch (Exception ex) {
            severity = FacesMessage.SEVERITY_ERROR;
            sMensaje = "Error al dar de baja: " + ex.getMessage();
    ...
    public void baja_Codirector() throws Exception {
        ...
        try {
            ...
            RequestContext context = RequestContext.getCurrentInstance();
            context.execute("PF('dlgBajaCodirector').hide()");
            ObservacionBajaCodirector ="";
        } catch (Exception ex) {
            severity = FacesMessage.SEVERITY_ERROR;
            sMensaje = "Error al dar de baja: " + ex.getMessage();
    ...
    public void baja_tribunal() throws Exception {
        ...
        try {
           ...
           observacionBaja="";
                    RequestContext context = RequestContext.getCurrentInstance();
            context.execute("PF('dlgBajaTribunal').hide()");
    ...
    public void alta_tribunal() throws Exception {
        ...
        try {
            ...
            severity = FacesMessage.SEVERITY_INFO;
                     ...
                     RequestContext context = RequestContext.getCurrentInstance();
            context.execute("PF('dlgAltaTribunal').hide()");
    ...
    public void edit() {
        ...
        try {
            ...
            RequestContext context = RequestContext.getCurrentInstance();
            context.execute("PF('dlgModTitulo').hide()");
    ...
    public void editCronograma() {
        System.out.println("Entro al edit de cronograma");
        String sMensaje = "";
        ...
        try {
            ...
            String encriptMD5 = a.hash(cronogramaObj.getDescripcion_act());
            System.out.println("md5:" + encriptMD5);

            System.out.println("los datos de este objeto son" + cronogramaObj.getDescripcion_act() + cronogramaObj.getFecha_fin() + cronogramaObj.getFecha_inicio() + cronogramaObj.getCronograma());

            cronogramaObj.setCronograma(cronoActividadRNLocal.findByCronograma(cronogramaObj.getId()).getCronograma());

            cronoActividadRNLocal.edit(this.getCronogramaObj());
            ...
            //elimino y agrego el organismo modificado a la lista
            int iPos = this.getListaCronogramaBean().getLstCronogramaActividad().indexOf(this.getCronogramaObj());

            this.getListaCronogramaBean().getLstCronogramaActividad().remove(iPos);
            this.getListaCronogramaBean().getLstCronogramaActividad().add(iPos, this.getCronogramaObj());

            //this.getCbAction().setDisabled(true);
            //this.setbCamposRequeridos(false);
            RequestContext context = RequestContext.getCurrentInstance();
            context.execute("PF('dlgCronograma').hide()");
        } catch (Exception ex) {
            severity = FacesMessage.SEVERITY_ERROR;
