...
@NamedQueries({
    ...
    @NamedQuery(name="proyAsesor.findByproyectos", query = "SELECT u FROM ProyectoAsesor u WHERE u.profesional.id =:docID" ),
    @NamedQuery(name = "Proyecto.FindDocenteAsesor", query = "SELECT u FROM ProyectoAsesor u WHERE u.profesional.id = :docente")
